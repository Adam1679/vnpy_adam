...
class BasicMonitor(QtWidgets.QTableWidget):
    ...
    def registerEvent(self):
        """注册GUI更新相关的事件监听"""
        self.signal.ws_connect(self.updateEvent)
...
class TradingWidget(QtWidgets.QFrame):
    ...
    def updateSymbol(self):
        ...
        print '-------------------------------trader/uiBasicWidget.py line969    \nsymbol:', symbol, '\nexchange:', exchange, '\ncurrency:', currency, '\nproductClass:', productClass, '\ngatewayName:', gatewayName
        # 打印这个productClass，然后修改ibGateway的line200和策略的初始化。
        # 下面这个函数的最后一行也要知道是什么参数。
    ...
    def connectSignal(self):
        """连接Signal"""
        self.signal.ws_connect(self.updateTick)
