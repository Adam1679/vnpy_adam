...
########################################################################
class Day5Strategy(CtaTemplate):
    """结合ATR和RSI指标的一个分钟线交易策略"""
    className = 'Day5Strategy'
    ...
    def __init__(self, ctaEngine, setting):
        ...
        self.stop_profit = 0
        """Constructor"""
        super(Day5Strategy, self).__init__(ctaEngine, setting)
    ...
    def onBar(self, bar):
        ...
        # 5日均线
        ma5 = talib.MA(self.closeArray, self.fastMaLength)
        # slow_arr = talib.WMA(self.closeArray, self.slowMaLength)
        # ma5 = talib.WMA(self.closeArray, self.fastMaLength)
        ...
        price_1 = self.closeArray[-1]
        price_2 = self.closeArray[-2]


        # 判断买卖
        crossOver = price_2 <= ma5_2 and price_1 > ma5_1  # 向上突破
        crossBelow = price_2 >= ma5_2 and price_1 < ma5_1  # 向下突破
        increasing = price_1 > ma5_1  # 价格线在上
        decreasing = price_1 < ma5_1  # 价格线在下
