...
class VtTradeData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.order_price = EMPTY_FLOAT          # 订单价格
        self.order_amount = EMPTY_FLOAT         # 订单数量
        self.order_time = None                  # 订单时间
        self.order_type = None                  # 订单类型，例如：做多，平空
        
        # 成交相关
        self.direction = EMPTY_UNICODE          # 成交方向
        self.offset = EMPTY_UNICODE             # 成交开平仓
        self.price = EMPTY_FLOAT                # 成交价格
        self.volume = EMPTY_INT                 # 成交数量，本次推送
        self.sum_volume = EMPTY_INT             # 成交数量，本单总数
